<form action="<?= base_url('index.php/process/update/array/') . $array->id ?>" method="post">
  ...
  <div class="mb-1">
    ...
    <input type="text" required name="name" class="form-control" id="companyname" placeholder="Example Company LTD" value="<?= isset($array->name) ? $array->name : '' ?>">
  </div>
  <div class="mb-1">
    ...
    <select class="selectize" aria-label="Default select example" id="line_name" placeholder="Pick a line..." multiple>
      ...
      <?php $arr = json_decode($array->query); foreach($query as $que): ?>
      <option value="<?= $que->id ?>" <?php if($arr) if(in_array($que->id, $arr)) echo "selected"; ?> ><?= $que->name ?></option>
      <?php endforeach ?>
    </select>
    <input type="hidden" value='<?= $array->query ?>' class="queryID" name="query" value="">
  </div>
  ...
  <div class="mb-1">
    ...
    <div class="input-group">
      ...
      <input type="text" name="get" value="<?= isset($array->get) ? $array->get : '' ?>" class="form-control" id="get" placeholder="key1=value&key2=value4" aria-describedby="basic-addon3 basic-addon4">
    </div>
  </div>
  ...
  <div class="position-relative" style="width:100%; height:200px">
    <div id="editor" class="editor"><?= isset($array->code) ? $array->code : '' ?></div>
  </div>
  ...
  <textarea name="code" id="query-field" class="d-none"><?= isset($array->code) ? $array->code : '' ?></textarea>
